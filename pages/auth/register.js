            ...
            <div className="relative">
                ...
                <div className="m-[6px] px-8 pb-10 border-2 border-blue-500 bg-black rounded-xl flex flex-col justify-center items-center relative">
                    ...
                    <form className="flex flex-col space-y-5 items-center" onSubmit={registerHandler.bind(this)}>
                        ...
                        />
                        <button type="submit"
                            className="m-auto py-1 px-10 bg-blue-800 hover:bg-transparent active:bg-blue-500 active:rounded-2xl rounded-2xl text-lg  border-2 border-blue-700 hover:border-blue-500 font-medium overflow-hidden">Register</button>
                    </form>
                </div>
            </div>
        </div>
